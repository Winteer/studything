...
//            ftpClient.enterLocalPassiveMode();
    ...
    public static boolean CreateDirectory(String remote) throws IOException {
    ...
    public static void main(String[] args) {
        //上传测试
        File file = new File("C:\\Users\\Administrator\\AppData\\Local\\Temp\\tomcat.4166560359717333317.8088\\work\\Tomcat\\localhost\\ROOT\\upload_7a3cab86_4390_4fa4_b190_fbc983482f1f_00000011.tmp");
        boolean flag = false;
        try {
            InputStream in = new FileInputStream(file);
            String path = "";
            path = FTPUtils.uploadFile("/tt/","test1.jpg",in);
